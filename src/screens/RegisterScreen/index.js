    ...
    cadastrar() {
        ...
        firebase.auth().createUserWithEmailAndPassword(
            ...
            if (error.code == 'auth/email-already-in-use') {
                Alert.alert("Esse endereco de e-mail já está sendo utilizado por outro usuário. Deseja recuperar sua senha?")
            }
            // error.code
            //error.message
                ...
                <Teclado>
                    <Area>
                        ...
                        <BlocoInputs>
                            ...
                            <InputNome onChangeText={(nome) => this.setState({ nome })} placeholder="EX. NOME COMPLETO" />
                        </BlocoInputs>
                        <BlocoInputs>
                            <Email>EMAIL:</Email>
                            <InputEmail autoCapitalize={false} onChangeText={(email) => this.setState({ email })} placeholder="EX. EMAIL@GMAIL.COM" />
                        </BlocoInputs>
                        <BlocoInputs>
                            <Senha>SENHA:</Senha>
                            <InputSenha onChangeText={(senha) => this.setState({ senha })} secureTextEntry={true} placeholder="************" />
                        </BlocoInputs>
                        <BlocoInputs>
                            <Cidades>EM QUAL CIDADE VOCÊ RESIDE?</Cidades>
                            <InputEsportes onChangeText={(cidade) => this.setState({ cidade })} placeholder="EX. SÃO JOSÉ DOS CAMPOS, TAUBATÉ" />
                        </BlocoInputs>
                        <BackgroundEntrar>
                            <TouchableOpacity>
                                <BotaoCadastrar onPress={this.teste}>CADASTRAR</BotaoCadastrar>
                            </TouchableOpacity>
                        </BackgroundEntrar>
                        <BlocoVoltar>
                            <TouchableOpacity>
