...
const slides = [
  ...
  },
  {
    ...
    title: 'COMO USAR:',
    text:
      'É simples, basta pesquisar por cidade ou categoria\nDepois só precisa entrar em contato via telefone',
  },
  {
    key: 'slide3',
    title: 'DICA IMPORTANTE:',
    text:
      'Para publicar um animal perdido, é necessário\na criação de uma conta',
  },
];
...
export default class IntroScreen extends React.Component {
  ...
  _renderItem = ({item}) => {
    return (
      <ImageBackground
        source={require('../../../assets/imgs/dog1.png')}
  ...
  render() {
    return (
      <AppIntroSlider
        activeDotStyle={{backgroundColor: '#002B77'}}
        showSkipButton={true}
