    ...
    return (
      <SafeArea>
        <Area>
          ...
          <BlocoDescricao>
            <Descricao>
              ESTÁ COM ALGUM PROBLEMA? QUER DAR UMA SUGESTÃO?{'\n'} ENTRE EM
              CONTATO
            </Descricao>
          </BlocoDescricao>
          <BlocoTexto>
            <Texto>
              E ai, tudo bem?{'\n'}Se você chegou até aqui, é sinal que você
              quer entrar em contato comigo.{'\n'}
              Caso queira dar uma sugestão, fazer uma critica, ou até mesmo
              saber mais sobre o meu trabalho, me mande uma mensagem.
            </Texto>
          </BlocoTexto>
          <BlocoContato>
            <TouchableOpacity
            ...
            <TouchableOpacity
              onPress={() => Linking.openURL('https://wa.me/5512997351169')}>
              <BackgroundFacebook>
